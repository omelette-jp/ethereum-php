...
function status($eth) {
    ...
    $rows[] = ['<b>Non standard methods</b>', 'PHP Ethereum controller API provides additional methods. They are part of the <a href="https://github.com/gmicommunity/ethereum-php">Ethereum PHP library</a>, but not part of JsonRPC-API standard.'];
