...
A fork of digitaldonkey/ethereum-php for modern PHP 8.1 / Laravel 8-9 Installations
...
This is the important part of [composer.json](https://github.com/gmicommunity/ethereum/blob/8.x-1.x/composer.json) in [Drupal Ethereum Module](https://drupal.org/project/ethereum).
...
See [UsingFilters](https://github.com/gmicommunity/ethereum-php/blob/master/UsingFilters.md) and [ethereum-php-eventlistener](https://github.com/gmicommunity/ethereum-php-eventlistener).
...
![architecture diagram](https://raw.githubusercontent.com/gmicommunity/ethereum-php/dev/doxygen-assets/ArchitectureDiagrammCS6.png "Drupal Ethereum architecture")
